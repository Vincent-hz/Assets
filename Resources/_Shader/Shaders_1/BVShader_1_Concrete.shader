...
////// Specular:
                ...
                float3 node_147 = (lerp((node_9188_if_leA*_DiffuseColor.rgb)+(node_9188_if_leB*_DiffuseMap_var.rgb),_DiffuseColor.rgb,node_9188_if_leA*node_9188_if_leB)*_BrightMap_var.rgb);
                float3 specularColor = node_147;
                float specularMonochrome;
                float3 diffuseColor = node_147; // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _BrightMap_var = tex2D(_BrightMap,TRANSFORM_TEX(i.uv0, _BrightMap));
                float3 node_147 = (lerp((node_9188_if_leA*_DiffuseColor.rgb)+(node_9188_if_leB*_DiffuseMap_var.rgb),_DiffuseColor.rgb,node_9188_if_leA*node_9188_if_leB)*_BrightMap_var.rgb);
                float3 diffColor = node_147;
                float3 specColor = node_147;
