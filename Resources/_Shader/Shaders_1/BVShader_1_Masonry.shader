...
////// Specular:
                ...
                float3 specularColor = node_3196;
                float specularMonochrome;
                float3 diffuseColor = node_3196; // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _DiffuseMap_var = tex2D(_DiffuseMap,TRANSFORM_TEX(i.uv0, _DiffuseMap));
                float3 node_3196 = lerp(_DiffuseColor.rgb,_DiffuseMap_var.rgb,_DiffuseFade);
                float3 diffColor = node_3196;
                float3 specColor = node_3196;
