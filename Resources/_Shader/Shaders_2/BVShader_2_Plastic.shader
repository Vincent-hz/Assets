...
////// Lighting:
                ...
                float3 node_8276 = (lambertianDiffuse( myshadergeom( halfDirection , i.normalDir , node_722 , viewDirection ) )*mixColorWithTint( lerp(_DiffuseColor.rgb,_DiffuseMap_var.rgb,_DiffuseFade) , _TintColor.rgb ));
