...
////// Lighting:
                ...
                float3 node_8276 = (lerp((node_1039_if_leA*node_6293)+(node_1039_if_leB*lambertianDiffuse( node_172 )),node_6293,node_1039_if_leA*node_1039_if_leB)*lerp((node_3871_if_leA*node_51)+(node_3871_if_leB*mixColorWithTint( _DiffuseMap_var.rgb , _DiffuseColor.rgb )),node_51,node_3871_if_leA*node_3871_if_leB));
