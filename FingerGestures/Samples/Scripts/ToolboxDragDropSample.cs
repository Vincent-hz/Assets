...
public class ToolboxDragDropSample : SampleBase
{
    ...
    void SaveInitialPositions()
    {
        ...
        for( int vertexNumbers = 0; vertexNumbers < initialPositions.Length; ++vertexNumbers )
            initialPositions[vertexNumbers] = dragObjects[vertexNumbers].position;
    }

    void RestoreInitialPositions()
    {
        for( int vertexNumbers = 0; vertexNumbers < initialPositions.Length; ++vertexNumbers )
            dragObjects[vertexNumbers].position = initialPositions[vertexNumbers];
    }
