...
public class SpectrumController : HighlightingController
{
    ...
    protected override void AfterUpdate()
    {
        ...
        int val = (int)counter;
        //Color col = new Color(GetColorValue(1020, val), GetColorValue(0, val), GetColorValue(0, val), 1f);//±ß¿òÑÕÉ«
          Color col = new Color(0.364f,1f,0f,1f);
